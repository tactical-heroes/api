...
namespace PANiXiDA.TacticalHeroes.Identity.Presentation.Features.IdentityUsers.Token;
...
internal static class OpenIddictTokenEndpoint
{
    ...
    private static ClaimsPrincipal CreatePrincipal(
        AuthenticatedIdentityUser user,
        IEnumerable<string> scopes)
    {
        ...
        {
            identity.AddClaim(IdentityAuthorizationClaimTypes.Permission, permission);
        }
    ...
    private static IEnumerable<string> GetDestinations(Claim claim)
    {
        return claim.Type switch
        {
            ...
            IdentityAuthorizationClaimTypes.Permission => [OpenIddictConstants.Destinations.AccessToken],
            _ => []
        };
    }
