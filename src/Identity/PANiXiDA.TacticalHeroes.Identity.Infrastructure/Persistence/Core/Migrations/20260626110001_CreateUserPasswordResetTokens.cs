...
public partial class CreateUserPasswordResetTokens : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.CreateTable(
            name: "identity_user_password_reset_tokens",
            columns: table => new
            {
            ...
            constraints: table =>
            {
                table.PrimaryKey("pk_identity_user_password_reset_tokens", x => x.identity_user_id);
                table.ForeignKey(
                    name: "fk_identity_user_password_reset_tokens_identity_users_identity_user_id",
        ...
        migrationBuilder.CreateIndex(
            name: "ix_identity_user_password_reset_tokens_expires_at_utc",
            table: "identity_user_password_reset_tokens",
